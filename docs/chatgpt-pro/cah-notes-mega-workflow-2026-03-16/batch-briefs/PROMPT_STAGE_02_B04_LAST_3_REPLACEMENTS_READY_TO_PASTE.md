...
You are generating the **last 3 replacement questions only** for batch `B04`.
...
- evening cannabis use can affect schoolwork even without paranoia or hallucinations

Prefer only fresh angle families like:

- clinically applied use of the 5 A’s or screening tools that does not restate the sequence already accepted/rejected
- cannabis harms framed through a different acute or chronic feature not already used
- alcohol risk framed through mixing substances, withdrawal, or burden-of-disease interpretation in a new scenario
- vaping or nicotine counselling framed in a new way that is not just “vaping is better than smoking”
- broader interpretation questions about why substance use still matters even when trends in some substances are declining

Originality rules:

- prefer counselling, interpretation, screening, and management-heavy questions
- avoid checklist recitation and sentence-level rewrites of the notes
- if a candidate question feels close to any banned family, replace it with another
